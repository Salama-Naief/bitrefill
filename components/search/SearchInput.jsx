  ...
  return (
    <div className='w-full'>
        <form onSubmit={handleSearchSubmit} className={`flex mx-6 text-gray-900 items-center relative `}>
            ...
            <input onChange={(e)=>setSearch(e.target.value)} type="text" className={`${darkMode?"focus:border-secondary-100 border-2 border-dark-200 bg-dark-100 text-white":"focus:border-customGray-200 border-2 border-customGray-100 text-main focus:bg-white bg-customGray-100"}  focus:outline-none flex-grow transition duration-200  px-6 py-2 w-full h-full rounded-full`} placeholder={t("common:search")}/>
