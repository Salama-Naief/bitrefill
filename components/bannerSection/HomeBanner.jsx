        ...
        <div className="bg-main w-full h-64 lg:h-screen md:h-96 relative overflow-hidden">
            ...
            <div className='text-center'>
                ...
                <div className=' flex justify-center my-4'>
                    <Link  href={"/cards/all-gift-cards"}><a className='transtion duration-200 active:scale-90 hover:bg-customGray-200 rounded-full px-6 text-xl py-3 bg-gray-200 text-black'>Browse 5000 + products</a></Link>
                </div>
            </div>
        </div>
        </div>
