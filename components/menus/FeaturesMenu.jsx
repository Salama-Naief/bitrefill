...
console.log("cardFeatures",cardFeatures)
  ...
  return (
    <motion.div initial={i18n.language==="ar"?{x:500}:{x:-500}} animate={{x:0}} transition={{duration:0.5,type:"just"}} className={`${darkMode?"bg-dark-200 text-white":"bg-white text-main"} w-2/3 px-4 z-20 h-screen overflow-y-scroll overflow-x-hidden flex flex-col fixed top-0 py-8 md:hidden ${i18n.language==="ar"?"right-0":"left-0"}`}>
    ...
    <div className={`${darkMode?"bg-dark-200 text-white":"bg-white text-main"} transition duration-200 w-full`}>
      ...
      <div className={`${card&&"text-secondary-100"} flex justify-between items-center my-2`}>
       <div onClick={()=>{setCard(!card); setMobile(false)}} className={` hover:underline text-xl  mx-3 font-semibold cursor-pointer `}>Gift Cards</div>  
        {   card?<MdKeyboardArrowDown className='text-3xl mx-4'/>:i18n.language==="ar"?<MdArrowBackIosNew className='mx-4'/>:<MdArrowForwardIos className='mx-4'/>}
      </div>
      <div  className={`${darkMode?"bg-dark-200 text-white":"bg-white text-main"} transition duration-200 w-full`}>
           ...
           <div className={`${cardFeatures&&"text-secondary-100"} flex justify-between items-center my-2`}>
              <div onClick={()=>{handleMenus("cardFeatures");setCardFeatures(!cardFeatures)}} className={` text-sm font-semibold py-1`}>Featured</div>
              {   cardFeatures?<MdKeyboardArrowDown className='text-3xl mx-4'/>:i18n.language==="ar"?<MdArrowBackIosNew className='mx-4'/>:<MdArrowForwardIos className='mx-4'/>}
            </div>
              { <motion.div initial={{display:"none"}} animate={cardFeatures?{display:"block"}:{display:"none"}} transition={{duration:0.5}} className="px-4">
                ...
                <div className={`${cardCategory&&"text-secondary-100"} flex justify-between items-center my-2`}>
                  <div onClick={()=>{handleMenus("cardCategory");setCardCategory(!cardCategory)}} className="text-sm font-semibold py-1">Categories</div>
                 {   cardCategory?<MdKeyboardArrowDown className='text-3xl mx-4'/>:i18n.language==="ar"?<MdArrowBackIosNew className='mx-4'/>:<MdArrowForwardIos className='mx-4'/>}
                </div>
               {<motion.div initial={{display:"none"}} animate={cardCategory?{display:"block"}:{display:"none"}} transition={{duration:0.5}} className=" px-4">
                ...
                <div className={`${cardPopular&&"text-secondary-100"} flex justify-between items-center my-2`}>
                  <div onClick={()=>{handleMenus("cardPopular");setCardPopular(!cardPopular)}} className="text-sm font-semibold py-1">Popular in Egypt</div>
                 {   cardPopular?<MdKeyboardArrowDown className='text-3xl mx-4'/>:i18n.language==="ar"?<MdArrowBackIosNew className='mx-4'/>:<MdArrowForwardIos className='mx-4'/>}
                </div>
    ...
    <div  className={`${darkMode?"bg-dark-200 text-white":"bg-white text-main"} `}>
      <div className={`${mobile&&"text-secondary-100"} flex justify-between items-center my-2`}>
       ...
       {   mobile?<MdKeyboardArrowDown className='text-3xl mx-4'/>:i18n.language==="ar"?<MdArrowBackIosNew className='mx-4'/>:<MdArrowForwardIos className='mx-4'/>}
      </div>
       {<motion.div initial={{display:"none"}} animate={mobile?{display:"block"}:{display:"none"}} transition={{duration:0.5}} className={`w-full px-4`}>
           ...
           <div className={`${mobileFeatures&&"text-secondary-100"} flex justify-between items-center my-2`}>
             ...
             {   mobileFeatures?<MdKeyboardArrowDown className='text-3xl mx-4'/>:i18n.language==="ar"?<MdArrowBackIosNew className='mx-4'/>:<MdArrowForwardIos className='mx-4'/>}
            </div>
           { <motion.div initial={{display:"none"}} animate={mobileFeatures?{display:"block"}:{display:"none"}} transition={{duration:0.5}} className=" px-4">
                ...
                <div className={`${mobileCategory&&"text-secondary-100"} flex justify-between items-center my-2`}>
                 ...
                 {   mobileCategory?<MdKeyboardArrowDown className='text-3xl mx-4'/>:i18n.language==="ar"?<MdArrowBackIosNew className='mx-4'/>:<MdArrowForwardIos className='mx-4'/>}
                </div>
               {<motion.div initial={{display:"none"}} animate={mobileCategory?{display:"block"}:{display:"none"}} transition={{duration:0.5}} className=" px-4">
                ...
                <div className={`${mobilePopular&&"text-secondary-100"} flex justify-between items-center my-2`}>
                 ...
                 {   mobilePopular?<MdKeyboardArrowDown className='text-3xl mx-4'/>:i18n.language==="ar"?<MdArrowBackIosNew className='mx-4'/>:<MdArrowForwardIos className='mx-4'/>}
                </div>
            { <motion.div initial={{display:"none"}} animate={mobilePopular?{display:"block"}:{display:"none"}} transition={{duration:0.5}} className="px-4">
                ...
                <div className={`${mobileTrend&&"text-secondary-100"} flex justify-between items-center my-2`}>
                  <div onClick={()=>{handleMenus("mobileTrend");setmobileTrend(!mobileTrend)}} className="text-sm font-semibold py-1">Trending</div>
                 {   mobileTrend?<MdKeyboardArrowDown className='text-3xl mx-4'/>:i18n.language==="ar"?<MdArrowBackIosNew className='mx-4'/>:<MdArrowForwardIos className='mx-4'/>}
                </div>
            {
    ...
    <div className={`p-4 `}>
      <hr></hr>
           <div onClick={()=>setOptionLayout(true)} className={`flex items-center my-2  rounded-full cursor-pointer px-2 py-1 transition duration-200 ${darkMode?"hover:bg-dark-100":"hover:bg-customGray-200"}`}>
           ...
           <div className={`flex items-center  rounded-full cursor-pointer  my-2 px-2 py-1 transition duration-200 ${darkMode?"hover:bg-dark-100":"hover:bg-customGray-200"}`}>
