...
function UserMenu({setUserMenu}) {
  ...
  return (
    <div className={` left-0 fixed top-0 w-full h-screen z-20`}>
        ...
        <motion.div initial={{scale:0}} animate={{scale:1}} transition={{duration:0.5}} className={`${darkMode?"bg-dark-100 text-white":"bg-white text-main"} rounded ${i18n.language==="ar"?"left-20":"right-20"} w-3/4 md:w-1/2 lg:w-1/3 absolute top-16 z-40`}>
